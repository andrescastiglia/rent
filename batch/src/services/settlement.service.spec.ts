...
describe('SettlementService', () => {
    ...
    describe('calculateSettlement', () => {
        ...
        it('should calculate settlement with correct amounts', async () => {
            ...
            mockQuery.mockResolvedValueOnce([
                { id: 'inv-1', invoice_number: 'INV-001', tenant: 'Tenant A', property: 'Prop 1', amount: '100000', paid_at: '2024-12-10', due_date: '2024-12-15' },
                { id: 'inv-2', invoice_number: 'INV-002', tenant: 'Tenant B', property: 'Prop 2', amount: '150000', paid_at: '2024-12-12', due_date: '2024-12-15' },
            ]);
    ...
    describe('processSettlement', () => {
        ...
        it('should process settlement and return success', async () => {
            ...
            const result = await service.processSettlement(mockOwnerId, mockPeriod, false);
        ...
        it('should return success without creating record in dry run mode', async () => {
            ...
            // Mock invoices
            mockQuery.mockResolvedValueOnce([
                { id: 'inv-1', invoice_number: 'INV-001', tenant: 'Tenant A', property: 'Prop 1', amount: '200000', paid_at: '2024-12-10', due_date: '2024-12-15' },
            ]);

            const result = await service.processSettlement(mockOwnerId, mockPeriod, true);
        ...
        it('should skip if settlement already completed', async () => {
            ...
            mockQuery.mockResolvedValueOnce([{ id: 'settlement-1', status: 'completed' }]);
    ...
    describe('T883 - Scheduled Date Logic', () => {
        it('should schedule on due date when payment is early', async () => {
            ...
            expect(result.scheduledDate.toISOString().split('T')[0]).toBe('2024-12-15');
        });
        ...
        it('should schedule same day when payment is late', async () => {
            ...
            expect(result.scheduledDate.toISOString().split('T')[0]).toBe('2024-12-20');
        });
        ...
        it('should use latest applicable date from multiple invoices', async () => {
            ...
            expect(result.scheduledDate.toISOString().split('T')[0]).toBe('2024-12-18');
        });
    });
});
