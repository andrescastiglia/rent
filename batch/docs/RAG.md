...
También se pueden ajustar `AI_EMBEDDING_REQUEST_BATCH_SIZE`,
`AI_EMBEDDING_MAX_ATTEMPTS`, `AI_EMBEDDING_RETRY_BASE_MS`,
`AI_EMBEDDING_TIMEOUT_MS` y, para un proxy compatible, `OPENAI_BASE_URL`.
