 ...
 */
export const createPropertySchema = (t: TranslationFunction) =>
  z.object({
    ...
    operations: z
      .array(z.enum(["rent", "sale"] as const))
      .min(1, t("required")),
    operationState: z
      .enum(["available", "rented", "reserved", "sold"] as const)
      .optional(),
 ...
 */
export const createTenantSchema = (t: TranslationFunction) =>
  z.object({
 ...
 */
export const createLeaseSchema = (t: TranslationFunction) =>
  z
    .object({
      ...
      inflationIndexType: z
        .enum(["icl", "ipc", "igp_m", "casa_propia", "custom"] as const)
        .optional(),
