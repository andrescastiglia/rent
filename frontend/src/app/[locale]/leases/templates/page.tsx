            ...
            <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 space-y-4">
              ...
              <div className="rounded-md border border-blue-200 bg-blue-50/80 dark:border-blue-900 dark:bg-blue-900/20 p-3">
                ...
                <div className="space-y-2">
                  {Object.entries(TEMPLATE_VARIABLE_GROUPS).map(
                    ([group, keys]) => (
                      <div key={group}>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {keys.map((key) => (
                            <button
                              ...
                              className="rounded-sm border border-blue-200 bg-white px-2 py-1 text-xs font-mono text-blue-700 hover:bg-blue-50 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-200 dark:hover:bg-blue-900/40"
                            >
                              {`{{${key}}}`}
                            </button>
                          ))}
