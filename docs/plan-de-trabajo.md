...
- [ ] Propagar `actor + companyId + rol + permisos` y validar pertenencia en todas las lecturas y mutaciones restantes: payments/invoices, bank accounts, owners y staff.
