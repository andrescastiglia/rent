...
*quiero* registrar interesados (compra o alquiler) con detalles específicos: número de teléfono, cantidad de personas, monto máximo a abonar, ingresos mensuales comprobables, relación ingreso/cuota o alquiler, tenencia de mascotas, tipos de garantías y tipo de inmueble (casa/depto),
